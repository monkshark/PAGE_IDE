...
class RustAnalyzerInstallerTest {
    ...
    fun downloadUrlUsesPageIdeAssets() {
        ...
        assertEquals(
            "https://github.com/monkshark/page-ide-assets/releases/download/rust-bundle/page-rust-analyzer-windows-x86_64-2025-05-26.gz",
            url,
        )
    }
    ...
    fun downloadUrlMacosArm64() {
        ...
        val url = installer.downloadUrl("2025-05-26")
        assertEquals(
            "https://github.com/monkshark/page-ide-assets/releases/download/rust-bundle/page-rust-analyzer-macos-aarch64-2025-05-26.gz",
            url,
        )
    }
    ...
    fun downloadUrlLinuxAmd64() {
        ...
        val url = installer.downloadUrl("2025-05-26")
        assertEquals(
            "https://github.com/monkshark/page-ide-assets/releases/download/rust-bundle/page-rust-analyzer-linux-x86_64-2025-05-26.gz",
            url,
        )
    }
